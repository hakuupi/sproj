...
for piece in [1]:  # trial 
    for performance in range(1,7):
        ...
        a1,a2,a3,a4,a5,a6 = p.getDegrees2D(p1[0], p1[1], angLST[0]),p.getDegrees2D(p1[0], p1[1], angLST[1]),p.getDegrees2D(p1[0], p1[1], angLST[2]),p.getDegrees2D(p1[0], p1[1], angLST[3]),p.getDegrees2D(p1[0], p1[1], angLST[4]),p.getDegrees2D(p1[0], p1[1], angLST[5])
